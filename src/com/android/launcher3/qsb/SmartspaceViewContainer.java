...
import com.android.launcher3.AfterHome;
 import com.android.launcher3.AfterHomeModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        AfterHome launcher = (AfterHome) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        AfterHomeModelDelegate delegate = (AfterHomeModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        AfterHome launcher = (AfterHome) ActivityContext.lookupContext(getContext());

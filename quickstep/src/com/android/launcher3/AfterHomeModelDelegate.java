...
public class AfterHomeModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "AfterHomeModelDelegate";
    ...
    public AfterHomeModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void onTargetsAvailable(List<SmartspaceTarget> targets) {
        ...
        mApp.getModel().enqueueModelUpdateTask((taskController, dataModel, apps) -> {
